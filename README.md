...
This is the beginning of something great. This portfolio is currently being built with a mobile first approach with Flexbox, CSS Grid, Javascript.

Once that it completed, my goal is to rebuilt it using React.
